...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (document.getElementById('header-template')) {
    templatePromises.push(loadTemplate('templates/header.html', 'header-template'));
  }

  // Load sidebar if container exists
  if (document.getElementById('sidebar-template')) {
    templatePromises.push(loadTemplate('templates/sidebar.html', 'sidebar-template'));
  }

  // Load footer if container exists
  if (document.getElementById('footer-template')) {
    templatePromises.push(loadTemplate('templates/footer.html', 'footer-template'));
  }
...
function initializeSidebar() {
  ...
  quickActions.forEach(action => {
    if (action.style.borderBottom && action.style.borderBottom.includes('rgba(255,255,255,0.05)')) {
